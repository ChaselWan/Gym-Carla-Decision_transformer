...
# trajectories_per_buffer: int,num of trajectories in each buffer
# num_steps: num of steps in each trajectories
# num_buffers: num of buffers in a dataset,lower than 49
# 
    ...
    while len(obss) < num_steps:
        buffer_num = np.random.choice(np.arange(50 - num_buffers, 50), 1)[0]  # np.arrange(1,50-num_buffers,1) = [1,2,...,50-num_buffers]
        ...
        frb = FixedReplayBuffer(
            ...
            observation_shape=(256, 256), # used to be(84,84)
            stack_size=4,
            update_horizon=1,
            gamma=0.99,
